...
window.dealView = async function(id) {
  ...
  // Editable value
  var valDisplay = content.querySelector('#deal-value-display');
  var valEdit = content.querySelector('#deal-value-edit');
  if (valDisplay) {
    valDisplay.addEventListener('click', function() { valDisplay.style.display = 'none'; valEdit.style.display = 'block'; content.querySelector('#f-deal-value').focus(); });
    content.querySelector('#btn-cancel-value').addEventListener('click', function() { valDisplay.style.display = ''; valEdit.style.display = 'none'; });
    content.querySelector('#btn-save-value').addEventListener('click', async function() {
      var newVal = parseFloat(content.querySelector('#f-deal-value').value) || 0;
  ...
  // Editable stage
  var stageSelect = content.querySelector('#f-deal-stage');
  if (stageSelect) {
